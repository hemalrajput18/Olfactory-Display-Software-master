...
F 1 "BME280 Temperature/Humidity Sensor" H 8520 3550 50  0000 R CNN
...
U 1 1 5E4765C4
P 12250 2100
F 0 "U?" H 12125 2125 50  0001 C CNN
F 1 "Stepper_Motor_Controller" H 12125 2033 50  0000 C CNN
...
U 1 1 5E49CCB5
P 13900 2850
F 0 "M?" H 14088 2974 50  0001 L CNN
F 1 "TCS Dosing Pump" H 14088 2928 50  0000 L CNN
F 2 "" H 13910 2840 50  0001 C CNN
F 3 "http://www.infineon.com/dgdl/Application-Note-TLE8110EE_driving_UniPolarStepperMotor_V1.1.pdf?fileId=db3a30431be39b97011be5d0aa0a00b0" H 13910 2840 50  0001 C CNN
	1    13900 2850
	1    0    0    -1  
$EndComp
Wire Wire Line
	12800 2300 14000 2300
Wire Wire Line
	14000 2300 14000 2550
Wire Wire Line
	12800 2500 13800 2500
Wire Wire Line
	13800 2500 13800 2550
Wire Wire Line
	12800 2400 13450 2400
Wire Wire Line
	13450 2400 13450 2750
Wire Wire Line
	13450 2750 13600 2750
Wire Wire Line
	12800 2600 13350 2600
Wire Wire Line
	13350 2600 13350 2950
Wire Wire Line
	13350 2950 13600 2950
Wire Wire Line
	12800 2700 12900 2700
Wire Wire Line
	12800 2800 13000 2800
Wire Wire Line
...
F 1 "+30V" V 13015 2928 50  0000 L CNN
...
F 1 "+12V" H 4265 4673 50  0000 C CNN
...
U 1 1 5E473DBE
P 4200 4600
F 0 "U?" H 3922 4346 50  0001 R CNN
F 1 "KNF_Pump" H 3922 4300 50  0000 R CNN
...
Wire Wire Line
	5000 3500 4700 3500
Wire Wire Line
	11750 5400 12900 5400
$Comp
L power:+5V #PWR?
U 1 1 5EA90541
P 5550 5750
F 0 "#PWR?" H 5550 5600 50  0001 C CNN
F 1 "+5V" V 5565 5878 50  0000 L CNN
...
Wire Wire Line
	12900 2700 12900 5400
Wire Wire Line
	5450 1650 11850 1650
$Comp
L Device:Speaker_Crystal LS?
U 1 1 5EAE66B3
P 5250 4550
F 0 "LS?" V 5169 4730 50  0001 L CNN
F 1 "Piezoelectric Atomiser" V 5530 5044 50  0000 R CNN
F 2 "" H 5215 4500 50  0001 C CNN
F 3 "~" H 5215 4500 50  0001 C CNN
	1    5250 4550
	0    1    1    0   
$EndComp
$Comp
L ADC-PI-NEW_V2-cache:Atomiser_Controller_Driver U?
U 1 1 5EAFD72E
P 5250 4050
F 0 "U?" H 5022 3929 50  0001 R CNN
F 1 "Atomiser_Controller_Driver" H 5535 3744 50  0000 L CNN
...
F 1 "ADS1115IDGS" H 9850 5439 50  0000 C CNN
...
U 1 1 5EB14288
P 10900 8400
F 0 "U?" H 10622 8129 50  0001 R CNN
F 1 "Breathing_Pressure_CCT" H 10622 8175 50  0000 R CNN
...
U 1 1 5EB19AC7
P 9950 8250
F 0 "U?" H 9950 8931 50  0000 C CNN
F 1 "MakeShiftSensor_ADS1115IDGS" H 9950 8840 50  0000 C CNN
